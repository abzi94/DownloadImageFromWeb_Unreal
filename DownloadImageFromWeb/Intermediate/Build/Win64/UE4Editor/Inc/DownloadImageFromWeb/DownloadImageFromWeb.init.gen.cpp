...
void EmptyLinkFunctionForGeneratedCodeDownloadImageFromWeb_init() {}
	...
	UPackage* Z_Construct_UPackage__Script_DownloadImageFromWeb()
	{
		...
		if (!ReturnPackage)
		{
			static UObject* (*const SingletonFuncArray[])() = {
				(UObject* (*)())Z_Construct_UDelegateFunction_DownloadImageFromWeb_DownloadImage1Delegate__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_DownloadImageFromWeb_DownloadFileUpdateProgressDelegate__DelegateSignature,
			};
			static const UE4CodeGen_Private::FPackageParams PackageParams = {
				"/Script/DownloadImageFromWeb",
				SingletonFuncArray,
